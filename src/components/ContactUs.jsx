  ...
  return (
    <div className="min-h-screen bg-gray-900 flex justify-center items-center px-4 py-10">
      <div className="bg-white shadow-lg rounded-2xl p-6 md:p-8 w-full max-w-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4" action={"mailto:rabibro063@gmail.com"} method="GET" encType="text/plain">
        ...
        <div className="mt-6 text-sm text-gray-500 text-center">
          Or email us directly at <a href="mailto:rabibro063@gmail.com"><span className="text-blue-600">support@scampuncher.com</span></a>
        </div>
